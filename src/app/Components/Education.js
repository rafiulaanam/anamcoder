...
const Education = () => {
  ...
  <h1 className='text-white font-bold text-2xl'>Educational Qualification</h1>
    <div className="flex flex-wrap w-full">
      <div className=" md:pr-10 md:py-6">
        ...
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
          <h2 className="font-semibold title-font text-lg text-[#72E2AE] mb-1 tracking-wider">Higher School Graduation</h2>
            <h2 className="font-medium title-font text-sm text-white mb-1 tracking-wider">Sylhet Govt. College.  <span className='italic text-xs' >(2018 - 2021)</span></h2>
            <p className="leading-relaxed text-gray-300">I am in Science group. Education Government took one year extra for Covid-19 pandemic and then our final results published in January 2021. I got GPA 5.00 out of 5.00 </p>
          </div>
        </div>
        <div className="flex relative pb-12">
          <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
